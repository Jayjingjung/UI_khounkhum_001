    ...
    <div>
        <v-app-bar
            ...
            <v-menu v-if="USER_ROLE !== 'ADMIN' && USER_ROLE !== 'USER'" offset-y>
                ...
                <v-list>
                    <v-btn color="white" to="create-expense-type" elevation="0" block><span
                            class="black--text">ເພີ່ມປະເພດລາຍຮັບ -
                            ລາຍຈ່າຍ</span><v-spacer></v-spacer></v-btn>
                ...
                <v-list>
                    <div v-if="USER_ROLE !== 'ACCOUNT_POYLOD'">
                        <v-btn v-if="USER_ROLE !== 'FINANCE'" block color="white" class="text-left" elevation="0"
                            ...
                            ອອກໃບປ່ອຍລົດ
                            <v-chip class="ma-2" x-small color="teal" text-color="white"
                                v-if="TOTAL_notiDetails != '0'">
                                {{ TOTAL_notiDetails }}
                            </v-chip>
                            <v-spacer></v-spacer>
                        </v-btn>
                        <v-btn v-if="USER_ROLE !== 'FINANCE'" color="white" block elevation="0"
                            style="border-radius: 0px" to="/operation-list">
                            ອອກໃບປະຕີບັດງານ
