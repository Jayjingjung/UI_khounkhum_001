<template>
  <v-app dark>
    ...
    <div style="display: flex;">
      ...
      <div
        v-if="USER_ROLE=='FOR_DOCUMENT_ADMIN' ||  USER_ROLE == 'BOR-HIN-KHUAT' || USER_NAME == 'borhinkuad-konengua' || USER_ROLE == 'borhinkuad-sykhoun' || USER_ROLE == 'borhinkuad-tha' || USER_ROLE == 'borhinkuad-xiengkong' ">
