<template>
    <div>
        ...
        <v-card width="900" class="mx-auto card-shadow mb-6"  rounded="lg" >
            <v-card-title style="background-color:#E57373;color:white">ບໍລິສັດ</v-card-title>
            <v-card-text class="pt-4">

                <v-form ref="form" v-model="valid" lazy-validation>
                    <div style="display:flex;justify-content:space-between;flex-direction:row">
                        <v-text-field :rules="nameRules" label="ບໍລິສັດ" outlined dense v-model="in_province"></v-text-field>
        ...
        <v-dialog v-model="modalUpdateLoca" width="350">
            <v-card elevation="2">
                ...
                <v-card-text>
                    <v-text-field label="ບໍລິສັດ" outlined dense v-model="in_province"></v-text-field>
