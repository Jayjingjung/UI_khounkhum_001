<template>
    <div>
        ...
        <div>
            <div>
                <v-btn style="width: 130;height: 40px; font-size: 18px;  border: 1px solid rgb(232, 76, 76);"
                ...
                <v-btn style="width: 130;height: 40px; font-size: 18px; border: 1px solid rgb(232, 76, 76);"
                    @click="setTokenAndFetch('1')">
                    ບໍນໍ້າຊາວ
                </v-btn>


                <v-btn style="width: 130;height: 40px; font-size: 18px; border: 1px solid rgb(232, 76, 76);"
                    @click="setTokenAndFetch('2')">
                    ນອງຄູນໃສ(62)
                </v-btn>


                <v-btn style="width: 130;height: 40px; font-size: 18px; border: 1px solid rgb(232, 76, 76);"
                    @click="setTokenAndFetch('ໂ')">
                    ນອງຄູນໃສ(32)
                </v-btn>
            </div>
        </div>
