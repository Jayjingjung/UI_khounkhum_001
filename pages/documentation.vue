            ...
            try {
                ...
                this.$axios.$post('/ShowAllResultOfServey.service', {
                    ...
                    if (data?.status === "00") {
                        ...
                        this.report_ResultOfServey = data.data.filter(item => item.name === 'nok' && item.nameDetail === 'ແຈ້ງການ1');
        ...
        functionSisterNok() {
            try {
                ...
                this.$axios.$post('/ShowAllResultOfServey.service', {
                    ...
                    if (data?.status === "00") {
                        // this.report_ResultOfServey = data?.data;
                        this.sisterNokAll = data.data.filter(item => item.name === 'nok' && item.nameDetail === 'ແຈ້ງການ1');
            ...
            try {
                ...
                this.$axios.$post('/ShowAllResultOfServey.service', {
                    ...
                    if (data?.status === "00") {
                        ...
                        this.ResultOfServey = data.data.filter(item => item.name === 'nok' && item.nameDetail === 'ແຈ້ງການ2');
            ...
            try {
                ...
                this.$axios.$post('/ShowAllResultOfServey.service', {
                    ...
                    if (data?.status === "00") {
                        // this.report_ResultOfServey = data?.data;
                        // this.ResultOfServey = data.data.filter(item => item.name === 'kk'|| item.name==='dd');
                        this.vichaiAll = data.data.filter(item => item.name === 'nok' && item.nameDetail === 'ແຈ້ງການ2');
