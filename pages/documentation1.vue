...
export default {
    ...
    methods: {
        ...
        // Filter Vichai Data
        filterTest() {
            this.vichai1 = this.payAll.filter((item) => item.name === "documment" && item.nameDetail === "ແຈ້ງການ1");
            this.vichai = this.vichai1
            this.testDoc = true;
        },
        // Filter Survey Data
        filterSurvey() {
            this.filterServey1 = this.payAll.filter((item) => item.name === "documment" && item.nameDetail === "ແຈ້ງການ2");
            this.filterServey = this.filterServey1
            this.surveydocument = true;
        },
        filterNokPay() {
            this.sisternok1 = this.payAll.filter((item) => item.name === "documment" && item.nameDetail === "ແຈ້ງການ3");
