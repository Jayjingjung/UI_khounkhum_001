                ...
                <v-card class="card-shadow mb-4" rounded="lg">
                    <v-card-title
                        ...
                        <div class="filter-section">
                            <v-btn v-if="!hideInboundNumber" color="primary" class="filter-button"
                                @click="setBound('in')">
                        ...
                        <div style="width: 400px; margin-left: 50px;" class="d-flex align-center">
                            ...
                            <div style="display: flex; margin-top: 28px;">
                                <div>
                                    <v-autocomplete style="width: 200px; margin-left: 15px; margin-right: 15px;"
                                        outlined dense label="ປະເພດ ທີເພີ່ມເອງ" :items="products_data_list"
                                        item-text="typeName" item-value="id" background-color="#13d95a"
                                        v-model="selectedProduct" @change="onGetProductDetails"></v-autocomplete>

                                    <v-autocomplete style="width: 200px; margin-left: 15px; margin-right: 15px;"
                                        outlined dense label="ບໍລິສັດ" :items="loca_data_list" item-text="province"
                                        item-value="id" background-color="#c6a50b" v-model="selectedLoca"
                                ...
                                <div>
                                    ...
                                    <v-autocomplete style="width: 100px; margin-left: 15px; margin-right: 15px;"
                                        outlined dense label="ບ້ວງ" :items="buang_data_list" item-text="nameOfBouang"
                                        item-value="nameOfBouang" background-color="#c6a50b" v-model="selectedBuang"
