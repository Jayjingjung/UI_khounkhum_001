<template>
    <div>
      ...
      <v-card class="x">
        ...
        <v-btn style="background-color: #f44336;width: 100px;display: flex;margin-bottom: 15px; margin-left: 15px;margin-top: 15px;" rounded to="/" text>
          <v-icon color="white">mdi-power</v-icon>
        </v-btn>
  
        <v-row>
          <v-col cols="12" md="3">
              <v-card to="confirm" height="100"  elevation="2" rounded="lg" width="180px"
                style="border: 1px solid  rgba(191, 0, 0, 0.8);">
                <v-card-text>
                  <div class="d-flex align-center">
                    <v-icon style="color: rgba(191, 0, 0, 0.8);" size="44">mdi-package</v-icon>
                    <div class="pl-5 pb-5 pt-5 pr-5 ">
                      <span style="font-size: 16pt;font-weight: bold;">ອານຸມັດອາໄລ</span><br />
                    </div>
                  </div>
                </v-card-text>
              </v-card>
              ...
              <v-card to="confirm" height="100"  elevation="2" rounded="lg" width="180px"
                ...
                <v-card-text>
                  <div class="d-flex align-center">
                    <v-icon style="color: rgba(191, 0, 0, 0.8);" size="44">mdi-package</v-icon>
                    <div class="pl-5 pb-5 pt-5 pr-5 ">
                      <span style="font-size: 16pt;font-weight: bold;">11111</span><br />
                    </div>
                  </div>
                </v-card-text>
              </v-card>
