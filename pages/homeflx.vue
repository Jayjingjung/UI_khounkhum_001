<template>
  <div>
    ...
    <v-card class="x">
      ...
      <v-btn
        style="background-color: #f44336;width: 100px;display: flex;margin-bottom: 15px; margin-left: 15px;margin-top: 15px;"
        rounded to="/" text>
      ...
      <v-row>
        <v-col cols="12" md="3">
          <v-card to="confirm" height="100" elevation="2" rounded="lg" width="100%"
            style="border: 1px solid  rgba(191, 0, 0, 0.8);">
            <v-card-text>
              <div class="d-flex align-center">
                <v-icon style="color: rgba(191, 0, 0, 0.8);" size="44">mdi-cog-refresh</v-icon>
