                    ...
                    <v-card>
                        <v-card-text>
                            ...
                            <v-card-actions>
                                ...
                                <v-spacer></v-spacer>
                                <v-btn color="primary" @click="updatePart">ອັບເດັບ</v-btn>
                            </v-card-actions>
                        </v-card-text>
                    </v-card>
                </v-dialog>
    ...
    methods: {
        ...
        async updatePart() {
            try {
                ...
                if (!this.selectedPart.namec || !this.selectedPart.price || !this.selectedPart.totall || !this.selectedPart.type || !this.selectedPart.namec) {
                    this.$swal.fire({
                        title: 'ແຈ້ງເຕືອນ',
