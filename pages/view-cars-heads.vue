                    ...
                    <v-card outlined>
                        <v-card-text class="px-7">
                            <div class="text-center">
                                <span style="font-size:22px;font-weight: bold;">ຂໍ້ມູນຢາງລົດ</span>
                            </div>
                            <div class="mt-6">
                                <div style="font-size: 18px; font-weight: bold;">
                                    ຢີ່ຫໍ້ຢາງລົດ:{{ brand_wheel_car }}
                                </div>
